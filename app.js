...
const totalBitcoinSupply = 21000000; // Fixed Bitcoin supply
// Get Bitcoin price from CoinGecko API (with fallback in case of failure)
function getBitcoinPrice() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield fetch('https://api.coingecko.com/api/v3/simple/price?ids=bitcoin&vs_currencies=usd');
            if (!response.ok) {
...
function fetchWorldBankDebtPercentage(countryCode) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield fetch(`https://api.worldbank.org/v2/country/${countryCode}/indicator/GC.DOD.TOTL.GD.ZS?format=json&date=2015:2020`);
            const data = yield response.json();
            if (data[1] && data[1].length > 0) {
                ...
                if (lastThreeValues.length > 0) {
                    const averageDebtPercentage = lastThreeValues.reduce((sum, item) => sum + item.value, 0) / lastThreeValues.length;
...
function fetchCountryEconomyDebt(countryCode) {
    return __awaiter(this, void 0, void 0, function* () {
...
function loadNationalDebtData(countryCode) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let debtPercentage;
            try {
                // First, try World Bank API
                debtPercentage = yield fetchWorldBankDebtPercentage(countryCode);
            }
            catch (error) {
                ...
                debtPercentage = yield fetchCountryEconomyDebt(countryCode);
            }
            const countryGDP = GDPs[countryCode] * 1000000000000; // Convert GDP from trillion to actual value
            ...
            const bitcoinPrice = yield getBitcoinPrice();
        ...
        `;
            ...
            selectedFlag === null || selectedFlag === void 0 ? void 0 : selectedFlag.classList.add('selected-flag');
        }
        catch (error) {
...
flagContainer.addEventListener('click', (event) => __awaiter(void 0, void 0, void 0, function* () {
